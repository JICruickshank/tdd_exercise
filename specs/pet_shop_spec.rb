...
class TestPetShop < Minitest::Test
  ...
  def test_add_or_remove_cash__add
    add_or_remove_cash(@pet_shop, 40)
    cash = total_cash(@pet_shop)
    assert_equal(1040, cash)
  end
  ...
  def test_remove_pet_by_name_pet_not_found
    remove_pet_by_name(@pet_shop, "Dave")
    assert_equal(6, @pet_shop[:pets].count)
